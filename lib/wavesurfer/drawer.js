...
WaveSurfer.Drawer = {
    ...
    scale: (navigator.userAgent.match(/(iPad|iPhone|iPod)/g)) ? 1 : window.devicePixelRatio,
    ...
    redraw: function () {
        ...
        if (peaksLength) {
            ...
            for(var i = 0; i < peaksLength; i++) {
                my.drawFrame(i, peaks[i], my.maxPeak);
            }
...
//            });
        ...
        // Draw markers.
        Object.keys(my.markers).forEach(function (key) {
